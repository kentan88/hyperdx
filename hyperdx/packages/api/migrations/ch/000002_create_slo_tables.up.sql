...
CREATE TABLE IF NOT EXISTS default.slo_definitions (
    ...
    numerator_query String,  -- ClickHouse query for success count
    denominator_query String,  -- ClickHouse query for total count
    alert_threshold Decimal64(3),  -- 80 = alert at 80% of error budget
