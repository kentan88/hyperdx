...
const TRACES_FIELDS = [
  ...
  { value: 'StatusCode', label: 'Status Code', type: 'number', description: '1 = OK, 2 = ERROR' },
  { value: 'Duration', label: 'Duration (ms)', type: 'number' },
  { value: 'SpanKind', label: 'Span Kind', type: 'string', description: 'SPAN_KIND_SERVER, etc.' },
];
...
const SLO_TEMPLATES = {
  ...
  traces: {
    latency: {
      ...
      filter: "ServiceName = '{service}' AND SpanKind = 'SPAN_KIND_SERVER'",
      goodCondition: 'StatusCode = 1 AND Duration < {latency_ms}',
    },
    availability: {
      name: 'Request Success Rate',
      description: '99.5% of requests succeed',
      filter: "ServiceName = '{service}' AND SpanKind = 'SPAN_KIND_SERVER'",
      goodCondition: 'StatusCode = 1',
    },
    error_rate: {
